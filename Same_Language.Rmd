...
library(lme4)
dir <- "M:/TEMPOP 2020/"
pop_hawk <- read_excel(paste0(dir,"/Data/Hawkins/Populist speech data.xlsx"))
load(paste0(dir,"/Data/pop_de.RData"))
df_de <- readtext(paste0(dir,"/Data/manifestosDE"), encoding="UTF-8")
```
